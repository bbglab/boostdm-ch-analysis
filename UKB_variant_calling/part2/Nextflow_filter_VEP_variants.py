...
def filter_chvariants(input_maf, output_folder):
    ...
    # Eliminate Indels and MNV
    maf = maf[maf["var_type"] == "SNV"]
    ...
    maf = maf[['#CHROM', 'POS', 'ID', 'REF', 'ALT', 'QUAL', 'AD_alt',
               'DP', 'VAF_alt', 'VAF_ref', 'ALT_num', 'var_type', 'Consequence',
               'IMPACT', 'SYMBOL', 'ENST', 'CDS_pos', 'Prot_pos', 'AA_change',
               'rs_ID', 'ENSP', 'EUR_AF', 'gnomAD_AF', 'gnomAD_AF_NFE', 'GT', 'AD',
               'INFO', 'FORMAT', 'VEP_cano', 'FILTER', 'VEP']]
